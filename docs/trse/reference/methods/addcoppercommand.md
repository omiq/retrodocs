...
This method adds a copper command to the custom copper list.
<p>
Here are the built-in copper instructions in TRSE:<b>
COPPER_DIWSTRT,
COPPER_DIWSTOP,
COPPER_DDFSTRT,
COPPER_DDFSTOP,
COPPER_SCROLL,
COPPER_WAIT_FOR_RASTER,
COPPER_PALETTE_START,
COPPER_MODULO_EVEN,
COPPER_MODULO_ODD
</b>
<p>
