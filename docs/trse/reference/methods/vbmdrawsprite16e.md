...
<h3>vbmDrawSprite16E( [address1], [address2], [address3] );</h3>
<ul>
...
<h3>Description</h3>
<p>
    A simple sprite routine to display a 16x16 sprite on the bitmap using an EOR operation.  The
...
<code>
        ...
        begin
            ...
            vbmDrawSprite16e( spr16L0, spr16M0, spr16R0 );  // draw the sprite with EOR
            
            waitforraster( 0 ); // wait for raster
    
            vbmSetPosition1( x, y ); // position the sprite, 1 pixel increments
            vbmDrawSprite16e( spr16L0, spr16M0, spr16R0 );  // draw sprite again with EOR, restoring the bitmap     
