...
<h3>vbmClearSpriteSlice( [address1], [byte-start], [byte-end] );</h3>
<ul>
...
<h3>Description</h3>
<p>
    A flexible sprite routine to erase or cut-out a single 'slice' of a sprite on the bitmap.
</p>
<p>
    Clearing a sprite slice has two useful features:
</p>
<ul>
    <li>It can be used to erase a sprite so it can be moved if you do not need to preserve the background</li>
    <li>It can be used to draw a mask by cutting out the sprite shape before drawing the real sprite</li>
</ul>
<p>
