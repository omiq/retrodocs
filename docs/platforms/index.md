...
| Platform | Languages in IDE | Notes |
|----------|-----------------|-------|
| [RGC BASIC](../basic/rgc-basic.md) | RGC BASIC | WASM in IDE ([open](https://ide.retrogamecoders.com/?file=petscii-data.bas&platform=rgc-basic)); native **basic** / **basic-gfx** ([repo](https://github.com/omiq/rgc-basic)) |
